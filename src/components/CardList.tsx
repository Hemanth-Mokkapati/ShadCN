  ...
  return (
    <div>
      ...
      <div className="flex flex-col gap-2">
        {list.map((item) => (
          <Card key={item.id} className="flex flex-row items-center gap-4 p-4 justify-between">
            ...
            <CardFooter className="p-0 font-medium text-sm">{item.count / 1000}K</CardFooter>
          </Card>
        ))}
      </div>
    </div>
